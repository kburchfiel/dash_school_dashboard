...
from app_functions_and_variables import offline_mode, read_from_online_db, df_curr_enrollment, create_filters_and_comparisons,create_color_and_pattern_variable_dropdowns, grade_reordering_map, create_pivot_for_charts, create_interactive_bar_chart_and_table
import pandas as pd
import sqlalchemy
...
# The following code uses the input variables specified in @callback() to
# generate a chart and table. 
